...
```html
<!-- for scaffolding-min: -->
<script src="https://cdn.jsdelivr.net/npm/@tinypatch/packager@0.0.0/dist/scaffolding/scaffolding-min.js"></script>

<!-- for scaffolding-full -->
<script src="https://cdn.jsdelivr.net/npm/@tinypatch/packager@0.0.0/dist/scaffolding/scaffolding-full.js"></script>
```

Replace `0.0.0` with the latest release from https://github.com/TinyPatch/packager/releases, for example `1.0.0`.
...
```js
// for scaffolding-min:
require('@tinypatch/packager/dist/scaffolding/scaffolding-min.js');
// for scaffolding-full:
require('@tinypatch/packager/dist/scaffolding/scaffolding-full.js');

// or, if you prefer ES6 imports,
// for scaffolding-min:
import '@tinypatch/packager/dist/scaffolding/scaffolding-min.js';
// for scaffolding-full:
import '@tinypatch/packager/dist/scaffolding/scaffolding-full.js';
```
